      ...
      $(resp).each(function (indexInArray, item) {
        ...
        <div class="col-lg-3">
            <button type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#exampleModal_`+item.sessionId+`">Add an Activity or resource</button>
            <div class="modal fade" id="exampleModal_`+item.sessionId+`" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button id="btnQuiz" type="button" class="btn btn-default col-lg-3" onclick="Quiz(`+ClassId+`,`+item.sessionId+`,'Quiz1','google.com')">
