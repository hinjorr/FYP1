...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=db-mysql-blr1-04213-do-user-11805380-0.b.db.ondigitalocean.com;port=25060;user=doadmin;password=AVNS_0R4qw4AGTg_LuDwE5eq;database=sql6500250", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.28-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.Property(e => e.PostedTo)
                    .IsRequired()
                    .HasMaxLength(60)
                    .HasColumnName("posted_to");
